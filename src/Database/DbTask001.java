...
Your boss says that internal project ids are irrelevant to him and that he 
isn't interested in how big the teams are. Since that's the case, he wants you 
to create another table by removing the internal_id and team_size columns from the existing 
...
public class DbTask001 {

	String query = "SELECT project_name, team_lead, income FROM Projects ORDER BY internal_id ASC;";
