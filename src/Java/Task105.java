...
public class Task105 {
	...
	public static void main(String[] args) {
		System.out.println(lateRide(0)); // Expected 0
		System.out.println(lateRide(1439)); // Expected 19
		System.out.println(lateRide(23)); // Expected 5
		System.out.println(lateRide(8)); // Expected 8
	}
