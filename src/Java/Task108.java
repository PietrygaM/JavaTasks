...
public class Task108 {
	...
	public static void main(String[] args) {
		...
		System.out.println(knapsackLight1(10, 5, 6, 4, 9)); // Expected 16
		System.out.println(knapsackLight2(10, 5, 6, 4, 9)); // Expected 16
	}

	// Method 1
	public static int knapsackLight1(int value1, int weight1, int value2, int weight2, int maxW) {
